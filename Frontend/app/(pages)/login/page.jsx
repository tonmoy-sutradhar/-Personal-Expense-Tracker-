      ...
      <div className="card bg-gradient-to-r from-blue-500 to-purple-600  w-full max-w-sm shrink-0 shadow-2xl rounded-lg  ">
        ...
        <form className="card-body ">
          ...
          <div className="form-control mt-6">
            <button className="btn btn-active bg-lime-400 text-black font-bold rounded-lg">
              Login
            </button>
          </div>
          ...
          {/* Google login */}
          <div className="flex justify-center gap-1  items-center w-[100%] border-2  rounded-lg bg-lime-300 px-1">
            ...
            {/* <button
                onClick={() => {
                  GoogleLogin()
                    ...
                    .catch((error) => {
                      toast.warning("Google login don't successful");
                    });
                }}
